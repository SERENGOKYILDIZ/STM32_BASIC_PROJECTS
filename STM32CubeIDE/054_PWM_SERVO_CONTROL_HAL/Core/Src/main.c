...
int main(void)
{
	...
	while (1)
	{
		...
		/* @brief
		 * 0.5ms is -90 degree. We need it in ms.
		 *
		 * 0.5ms/20ms = %2.5 duty cycle
		 * 20.000 * %2.5 = 500 Pulse (for -90 degree)*/
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_1, 500);
		HAL_Delay(2000);

		/* @brief
		 * 1.5ms is 0 degree. We need it in ms.
		 *
		 * 1.5ms/20ms = %7.5 duty cycle
		 * 20.000 * %7.5 = 1500 Pulse (for 0 degree)*/
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_1, 1500);
		HAL_Delay(2000);


		/* @brief
		 * 2.5ms is +90 degree. We need it in ms.
		 *
		 * 2.5ms/20ms = %12.5 duty cycle
		 * 20.000 * %12.5 = 2500 Pulse (for +90 degree)*/
